...
import { db } from './Firebase'; // Ensure to export your firebase configuration
...
function Booking() {
  ...
  const [departments] = useState(['Cardiology', 'Neurology', 'Orthopedics', 'Pediatrics']);
  const [doctors] = useState(['Dr. Rajiv', 'Dr. Jaydev', 'Dr. L Smith', 'Dr. Bown']);
  ...
  useEffect(() => {
    if (mapsLoaded) {
      const fetchHospitals = () => {
        const location = new window.google.maps.LatLng(20.2961, 85.8245);
  ...
  const handleChange = (e) => {
    ...
    const field = id.replace('booking-', '');
  ...
  <path fill="#000" fillRule="evenodd" d="M41.8405 33.8181C31.7437 43.9148 29.8334 59.6549 37.2784 71.8393L40.2339 76.6762L40.8342 77.4779C46.8175 85.4685 53.3638 93.0215 60.4234 100.079C62.1245 101.78 64.8859 101.776 66.587 100.076C73.6611 93.0031 80.236 85.4229 86.2356 77.4187L86.8503 76.5986L89.9099 71.6009C97.338 59.4676 95.4831 43.8245 85.4234 33.7649C73.403 21.7445 53.8609 21.7977 41.8405 33.8181ZM63.5 72C71.5081 72 78 65.5081 78 57.5C78 49.4919 71.5081 43 63.5 43C55.4919 43 49 49.4919 49 57.5C49 65.5081 55.4919 72 63.5 72Z" clipRule="evenodd"></path>
  ...
  <g>
    <path d="m20.71 19.29-3.4-3.39A7.92 7.92 0 0 0 19 11a8 8 0 1 0-8 8 7.92 7.92 0 0 0 4.9-1.69l3.39 3.4a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 11a6 6 0 1 1 6 6 6 6 0 0 1-6-6z"></path>
          ...
          <Link to='/booking-ani'><button type='submit' id='booking-appointment'>Confrim Your Appointment</button></Link>
          </form>
        </div>
      </div>
    </div>
